//constants https://codepen.io/dimidrola/pen/NRqNYY?editors=0010
...
loader.add('IMG_MACHINE',IMG_MACHINE);
loader.add('IMG_BODY',IMG_BODY);
loader.add('IMG_BUTTON',IMG_BUTTON);
